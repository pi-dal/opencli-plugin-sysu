...
cli({
  site: 'sysu',
  name: 'jwxt-exams',
  description: 'SYSU exam schedule — query exam arrangements',
  access: 'read',
  domain: SYSU_DOMAIN,
  navigateBefore: SYSU_NAVIGATE_URLS.exams,
  ...
  func: async (page: any, kwargs: any) => {
    ...
    const script = buildJwxtQueryScript(SYSU_ENDPOINTS.exams, params)
